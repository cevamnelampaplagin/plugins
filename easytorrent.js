(function () {
    ...
    // Переклади
    const translations = {
        easytorrent_title: { ru: 'Рекомендации торрентов', en: 'Torrent Recommendations', ua: 'Рекомендації торрентів' },
        easytorrent_desc: { ru: 'Показывать рекомендуемые торренты на основе качества, HDR и озвучки', en: 'Show recommended torrents based on quality, HDR and audio', ua: 'Показувати рекомендовані торренти на основі якості, HDR та озвучки' },
        recommended_section_title: { ru: 'Рекомендуемые', en: 'Recommended', ua: 'Рекомендовані' },
        show_scores: { ru: 'Показывать оценки', en: 'Show scores', ua: 'Показувати оцінки' },
        show_scores_desc: { ru: 'Отображать оценку качества торрента', en: 'Display torrent quality score', ua: 'Відображати оцінку якості торренту' },
        ideal_badge: { ru: 'Идеальный', en: 'Ideal', ua: 'Ідеальний' },
        recommended_badge: { ru: 'Рекомендуется', en: 'Recommended', ua: 'Рекомендується' },
        config_json: { ru: 'Конфигурация (JSON)', en: 'Configuration (JSON)', ua: 'Конфігурація (JSON)' },
        config_json_desc: { ru: 'Нажмите для просмотра или изменения настроек', en: 'Click to view or change settings', ua: 'Натисніть для перегляду або зміни налаштувань' },
        config_view: { ru: 'Просмотреть параметры', en: 'View parameters', ua: 'Переглянути параметри' },
        config_edit: { ru: 'Вставить JSON', en: 'Paste JSON', ua: 'Вставити JSON' },
        config_reset: { ru: 'Сбросить к заводским', en: 'Reset to defaults', ua: 'Скинути до заводських' },
        config_error: { ru: 'Ошибка: Неверный формат JSON', en: 'Error: Invalid JSON format', ua: 'Помилка: Невірний формат JSON' }
    };
